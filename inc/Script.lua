...
bd = '🙋🏻‍♂╿العضو ['..USERNAME..'](tg://user?id='..msg.sender_user_id_..') \n📌╽لأستخدام البوت عليك الاشتراك ب قناة السورس @sultanipa209'
...
if MsgText[1] == "قائمه الغريب" then 
...
if MsgText[2] == "قائمه الاغبياء" then
if not msg.Rank then end
...
if MsgText[2] == "قائمه الغريب" then
if not msg.Rank then end
...
🔖| ملاحظه : الـ ★ تعنـي ان البوت مشرف في المجموعـة.]]
...
if MsgText[1] == "اذاعه عامه" or MsgText[1] == "اذاعه عامه 📢" then		
if not msg.SudoUser then return"♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if not msg.SudoBase and not redis:get(max..'lock_brod') then 
return "📡*│* الاذاعه مقفوله من قبل المطور الاساسي  🚶" 
end
...
if MsgText[1] == "اذاعه خاصه" or MsgText[1] == "اذاعه خاصه 🗣" then		
if not msg.SudoUser then return "♦️*│*هذا الامر يخص {المطور} فقط  \n💥" end
if not msg.SudoBase and not redis:get(max..'lock_brod') then 
return "📡*│* الاذاعه مقفوله من قبل المطور الاساسي  🚶" 
end
redis:setex(max..'fwd:pv'..msg.sender_user_id_,300, true) 
return "📭│حسننا الان ارسل الكليشه للاذاعه خاصه \n🔛"
end
...
return '👨🏾‍🔧│ اصدار سورس sultanipa  : *v'..version..'* \n📡'
end

if (MsgText[1] == 'تحديث السورس' or MsgText[1] == 'تحديث السورس 🔂') then
if not msg.SudoBase then return "♦️*│*هذا الامر يخص {المطور الاساسي} فقط  \n💥" end
local GetVerison = https://github.com/sultsn0000/sultanbot.github.io/GetVersion.txt') or 0
...
sendMsg(msg.chat_id_,msg.id_,"📛*│* عذرا النسخه الاحتياطيه هذه ليست للبوت » ["..Bot_User.."]  \n💥")
end
else 
...
local inline = {{{text="⚜│قناه السـورس ضـغـط هنا ",url="t.me/sultanipa209"}}}
send_key(msg.sender_user_id_,'  [⚜│قناة سورس : جلبريك](sultanipa209)',nil,inline,msg.id_)
return false
end
...
📨│ [قناه السورس](https://t.me/sultanipa209)
📨| [قروب السورس](https://t.me/sultanipa209)
